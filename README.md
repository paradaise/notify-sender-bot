...
<div style="display: flex; justify-content: center; gap: 10px;">
  <img src="./demo/change_message.png" alt="Изменение сообщения" width="45%">
  <img src="./demo/change_interval.png" alt="Изменение интервала" width="45%">
</div>
...
<div style="display: flex; justify-content: center; gap: 10px;">
  ...
  <img src="./demo/exception_add_channel.png" alt="Исключение при добавлении канала" width="45%">
</div>
...
<div style="display: flex; justify-content: center; gap: 10px;">
  <img src="./demo/show_stopped_task.png" alt="Показать остановленную задачу" width="45%">
  <img src="./demo/show_working_task.png" alt="Показать запущенную задачу" width="45%">
</div>
